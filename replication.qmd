...
[@henningsen2020censreg]. The complicated part of the estimation is to 
extract the right hand side of the model formula to define a vector of zeroes 
with a length equal to the right hand side plus two as starting point for the 
Maximum Likelihood estimation (e.g., including the depending variable and 
